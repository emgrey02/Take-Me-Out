...
/// </summary>
public class FMODOutdoorCrowd2 : MonoBehaviour
{
    ...
    void Update()
    {
        if (eventEmitter != null && !eventEmitter.IsPlaying()) return;
        ...
        currDistance = Mathf.Lerp(currDistance, targetDistance, Time.deltaTime * smoothSpeed);
    ...
    void PerformScan()
    {
        ...
        targetDistance = adjustedDist.Min();
